...
"<"      return yy::parser::make_MINOR      (loc);
"<="     return yy::parser::make_MINOREQUAL (loc);
">"      return yy::parser::make_MAJOR      (loc);
">="     return yy::parser::make_MAJOREQUAL (loc);
...
":"      return yy::parser::make_COLONS     (loc);
...
yy::parser::symbol_type check_keywords(std::string lexeme, yy::location& loc) {
  ...
  return yy::parser::make_EXTERN(loc);
    ...
    return yy::parser::make_FLOWEND(loc);
  } else if (lexeme == "var") {
